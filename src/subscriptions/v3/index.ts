...
export const v3SubscriptionMethods = (request: ApiRequest): SubscriptionVersions['v3'] => ({
  ...
  getUpdatePaymentLink: (uuid) => request(getUrl(`${baseUrl}/${uuid}/update-payment-link`, {}), { method: 'GET' }),
  getPortalLink: (uuid) => request(getUrl(`${baseUrl}/${uuid}/customer-portal`, {}), { method: 'GET' }),
  getCancelSubscriptionLink: (uuid) => request(getUrl(`${baseUrl}/${uuid}/cancel-payment-link`, {}), { method: 'GET' }),
