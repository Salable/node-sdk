...
export type LicenseVersions = {
  [Version.V2]: {
     ...
     *
     * @returns {Promise<CheckLicensesCapabilitiesResponse | undefined>} The capabilities of the license passed
     */
    check: (options: CheckLicenseInput) => Promise<CheckLicensesCapabilitiesResponse | undefined>;
  };
};
